...
@implementation NSObject (LKLayImSwipeView)

- (CGSize)swipeViewItemSize:(__unused LKSwipeView *)swipeView { return CGSizeZero; }
- (void)swipeViewDidScroll:(__unused LKSwipeView *)swipeView {}
- (void)swipeViewCurrentItemIndexDidChange:(__unused LKSwipeView *)swipeView {}
- (void)swipeViewWillBeginDragging:(__unused LKSwipeView *)swipeView {}
- (void)swipeViewDidEndDragging:(__unused LKSwipeView *)swipeView willDecelerate:(__unused BOOL)decelerate {}
- (void)swipeViewWillBeginDecelerating:(__unused LKSwipeView *)swipeView {}
- (void)swipeViewDidEndDecelerating:(__unused LKSwipeView *)swipeView {}
- (void)swipeViewDidEndScrollingAnimation:(__unused LKSwipeView *)swipeView {}
- (BOOL)swipeView:(__unused LKSwipeView *)swipeView shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)swipeView:(__unused LKSwipeView *)swipeView didSelectItemAtIndex:(__unused NSInteger)index {}

@end


@interface LKSwipeView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
- (void)setDataSource:(id<LKSwipeViewDataSource>)dataSource
{
...
- (void)setDelegate:(id<LKSwipeViewDelegate>)delegate
{
...
- (void)setAlignment:(LKSwipeViewAlignment)alignment
{
...
- (void)updateScrollViewDimensions
{
    ...
    switch (_alignment)
    {
        case LKSwipeViewAlignmentCenter:
        {
            if (_vertical)
            {
...
- (CGFloat)offsetForItemAtIndex:(NSInteger)index
{
    ...
    if (_wrapEnabled)
    {
        if (_alignment == LKSwipeViewAlignmentCenter)
        {
...
{
    //get number of items
    _numberOfItems = [_dataSource numberOfItemsInLKSwipeView:self];
